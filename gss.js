...
var randomAngle = 0;
var arrowTween; // Declare the arrowTween variable
...
function loose() {
  ...
  TweenMax.to("#bow polyline", 0.4, {
    ...
    ease: Elastic.easeOut,
    onComplete: createNewArrow
  });

  // Other TweenMax animations...
}
...
function createNewArrow() {
  ...
  arrowTween = TweenMax.to([newArrow], 0.5, {
    force3D: true,
    bezier: {
      type: "cubic",
      values: path,
    ...
    onUpdate: hitTest,
    onUpdateParams: [arrowTween], // Pass the arrowTween to onUpdateParams
    onComplete: onMiss,
